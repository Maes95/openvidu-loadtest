...
#cd selenium-test/
#mvn -Dtest=OpenViduLoadTest -DbrowserVersion=80 -DAPP_URL="https://$ET_SUT_HOST:8080/" -DOPENVIDU_URL="https://$ET_SUT_HOST:4443/" -DRESULTS_PATH=../../results/ -DSESSIONS=1 -DUSERS_SESSION=2 -DPRIVATE_KEY_PATH=../webapp/key.pem test